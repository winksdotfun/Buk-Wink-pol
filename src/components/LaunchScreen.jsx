    ...
    <div className="relative md:w-[500px] sm:w-[300px] bg-[#161616] shadow-lg p-2 flex flex-col items-center">
      ...
      <div className="bg-[#161616] md:w-[485px] p-1 mt-1 h-fit rounded-md w-fit">
        ...
        <div className="flex justify-center items-center gap-4 md:mt-6 sm:mt-1.5">
          <a href={`https://Prawasa.com/hotels/nft-details?nftId=${tokenID}`} target="_blank" rel="noopener noreferrer" className="text-white bg-[#331D19] border border-[#7B3F26] md:px-9 md:py-2 sm:text-xs sm:px-4 sm:py-1 md:text-[16px] rounded-lg ">
            Hotel Details
          </a>
          <button
